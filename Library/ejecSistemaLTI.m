...
% SNRdB:  Relacion potencia de señal a potencia de ruido en dB
...
% -------------------------------------------------------------------------
function [seq, err_c,err_m, SNRdB_symb,SNRdBb_c] = ...
    ejecSistemaLTI(M, Nbits, hCod, SNRdB, hDecod, hErr_c, hErr_m, ...
    tipoRuido,tasaCod, patronPerforado)
...
[r_c,SNRdB_symb,SNRdBb_c] = CDE_UAC_LTI(t_c,SNRdB,tipoRuido);
%% Recepción
